<div class="container-fluid d-flex justify-content-center align-items-center pt-5">
    <div class="card justify-content-center align-items-center shadow h-100 w-100 pt-3">
        <img id="product-immage" src="<?php echo $templateParams["product"]["immagine"] ?>" class="card-img-top pt-2 px-2" alt="">
