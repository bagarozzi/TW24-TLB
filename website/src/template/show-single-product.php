    ...
    <div class="card justify-content-center align-items-center shadow h-100 w-100">
        ...
        <div class="card-body d-flex flex-column justify-content-between">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="quantity" name="quantity" min="1" max="<?php echo $templateParams["product"]["disponibilita"] ?>" value="1">
            </div>
            <button class="btn btn-dark mt-3 w-100">Add to cart</button>
        </div>
    </div>
</div>
