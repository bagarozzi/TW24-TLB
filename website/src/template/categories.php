        ...
        <div class="row">
            <div class="col-md-6 mb-3 mb-sm-0 p-4">
                <div class="card text-bg-dark">
                    <img src="resources/slides/fert.jpg" class="card-img" alt="Handful of blue fertilizer">
            ...
            <div class="col-md-6 p-4">
                <div class="card text-bg-dark">
                    <img src="resources/products/cropped-nh-ch10.png" class="card-img" alt="Haversting crops">
                    <div class="card-img-overlay">
                        <div class="d-flex flex-column justify-content-end align-items-between h-100 p-2">
        ...
        <div class="row">
            <div class="col-md-6 mb-3 mb-sm-0 p-4">
                <div class="card text-bg-dark w-100">
                    <img src="resources/equipment.jpg" class="card-img" alt="Tractor working in a field">
                    <div class="card-img-overlay">
                        <div class="d-flex flex-column justify-content-end align-items-between h-100 p-2">
            ...
            <div class="col-md-6 p-4">
                <div class="card text-bg-dark">
                    <img src="resources/slides/cow.png" class="card-img" alt="A cow">
                    <div class="card-img-overlay">
